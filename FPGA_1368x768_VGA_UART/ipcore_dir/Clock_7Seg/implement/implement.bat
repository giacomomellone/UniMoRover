...
xst -ifn xst.scr
move Clock_7Seg_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Clock_7Seg_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Clock_7Seg_exdes.ucf Clock_7Seg_exdes

echo 'Running map'
map -timing -pr b Clock_7Seg_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm Clock_7Seg_exdes -w routed.ncd routed.vhd
cd ..
